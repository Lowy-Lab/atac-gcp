...
gcloud storage cp ${workdir}/outs/per_sample_outs/${sample}/trimmed/*.fq.gz .
...
gcloud storage cp sorted.b* ${workdir}/outs/per_sample_outs/${sample}/bams/
gcloud storage cp bowtie2.log ${workdir}/outs/per_sample_outs/${sample}/logs/bowtie2.log
gcloud storage cp bowtie2_alignment-metrics.txt ${workdir}/outs/per_sample_outs/${sample}/logs/bowtie2_alignment-metrics.txt